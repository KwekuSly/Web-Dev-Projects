          ...
          {categories &&
            categories.map((category) => (
              <motion.div
                ...
                key={category.id}
                className={`group ${
                  filter == category.urlParamName ? "bg-green-600" : "bg-white"
                } w-24 min-w-[94px] h-28 cursor-pointer rounded-lg drop-shadow-xl flex flex-col gap-3 text-center items-center justify-center hover:bg-green-500 duration-50 transition-all ease-in-out`}
