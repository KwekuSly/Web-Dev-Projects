      ...
      <div className="group flex justify-center items-center flex-col border-2 border-dotted border-gray-300 w-full h-225 md:h-420 cursor-pointer rounded-lg">
        {isLoading ? <Loader /> : <>
            ...
            <><div className="relative h-full">
              ...
              <button type="button" className="absolute bottom-3 right-3 p-3 rounded-full bg-green-500 text-xl cursor-pointer outline-none hover:shadow-md duration-500 trasition-all ease-in-out" onClick={deleteImage}
        ...
        <div className="flex items-center w-full">
          <button type="button" className="ml-00 md:ml-auto w-full md:w-auto border-none outline-none bg-emerald-500 px-12 py-2 rounded-lg text-lg text-white font-semibold" onClick={saveDetails}>Save</button>
        </div>
      </div>
    </div>
  )
